...
public class GuiDSession implements ActionListener,iGuiDPropMessenger
{
	...
	public void createExportWindow()
	{
		...
		Image img = exportWindow.getToolkit().createImage("Images/icons/GuiD_icon.png");
		...
		jtfMethodName.setText("genericBoringMethodName");
		...
		jtfObjectName.setText("myguidobject");
