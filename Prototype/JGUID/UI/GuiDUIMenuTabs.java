...
public class GuiDUIMenuTabs extends JTabbedPane
{
	...
	{
		//Project
		 optionFilenew = new GuiDUITabButton("New Project",new ImageIcon("Images/icons/new_project.png"));
		 optionFileopen = new GuiDUITabButton("Open Project",new ImageIcon("Images/icons/open_project.png"));
		 optionFilesave = new GuiDUITabButton("Save Project",new ImageIcon("Images/icons/save.png"));

		//Edit
		 optionEditcut = new GuiDUITabButton("Cut",new ImageIcon("Images/icons/cut.png"));
		 optionEditcopy = new GuiDUITabButton("Copy",new ImageIcon("Images/icons/copy.png"));
		 optionEditpaste = new GuiDUITabButton("Paste",new ImageIcon("Images/icons/paste.png"));
		 optionEditdelete = new GuiDUITabButton("Delete",new ImageIcon("Images/icons/delete.png"));

		//Help
		 optionHelpUse = new GuiDUITabButton("Using JGuiD",new ImageIcon("Images/icons/help.png"));
		 optionHelpBatch = new GuiDUITabButton("Batch Files",new ImageIcon("Images/icons/batchfile.png"));
		 optionHelpMultiple = new GuiDUITabButton("Multiple Screens",new ImageIcon("Images/icons/multiple.png"));
		 optionHelpHistory = new GuiDUITabButton("History of JGuiD",new ImageIcon("Images/icons/history.png"));

		//Code
		 optionCodeexport = new GuiDUITabButton("Export Code",new ImageIcon("Images/icons/java.png"));
		 optionCodeviewcode = new GuiDUITabButton("View Code",new ImageIcon("Images/icons/magnify.png"));		
	}
