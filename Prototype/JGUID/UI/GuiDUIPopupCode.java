...
public class GuiDUIPopupCode extends JFrame implements HyperlinkListener
{
	...
	public GuiDUIPopupCode(String title,String page,String type)
	{
		...
		codeTabs.add(new JScrollPane(ep2),"Variables/Components");
		codeTabs.add(new JScrollPane(ep3),"startGUI()");
		codeTabs.add(new JScrollPane(ep4),"Method Initialisation");
		codeTabs.add(new JScrollPane(ep5),"Button Actions");
