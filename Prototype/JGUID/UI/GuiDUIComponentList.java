...
public class GuiDUIComponentList extends JDesktopPane 
{
	...
	public GuiDUIComponentList()
	{
		...
		but = new JButton(new ImageIcon("Images/compJButton.png"));
		lbl = new JButton(new ImageIcon("Images/compJLabel.png"));
		radbut = new JButton(new ImageIcon("Images/compJRadioButton.png"));
		chk = new JButton(new ImageIcon("Images/compJCheckBox.png"));
		txtfld = new JButton(new ImageIcon("Images/compJTextField.png"));
		passfld = new JButton(new ImageIcon("Images/compJPasswordField.png"));
		txtarea = new JButton(new ImageIcon("Images/compJTextArea.png"));
		lst = new JButton(new ImageIcon("Images/compJList.png"));
		cmb = new JButton(new ImageIcon("Images/compJComboBox.png"));
